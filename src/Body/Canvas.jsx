...
function Canvas(props) {
  ...
  const returnDropZone=()=>{
    ...
    const handleDrop = (event) => {
      ...
      if (files.length > 0) {
        props.readDataFromFile(files[0]);
      }
    };
    ...
    if(props.loading){
      ...
      return(
        <div className="h-full flex justify-center items-center col-span-6 bg-gif" 
          ...
          onDrop={handleDrop}>
              <label htmlFor="dropzone-file" className=" m-10 flex flex-col items-center justify-center w-2/6 h-3/6 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-orange-200 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
